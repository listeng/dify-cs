  ...
  const handleGetEMailVerificationCode = async () => {
    try {
      ...
      if (res.result === 'success') {
        ...
        router.push(getRoutePath('webapp-reset-password/check-code', Object.fromEntries(params.entries())))
      }
    ...
    <div className="flex flex-col gap-3">
      ...
      <Link
        href={getSigninPath(
          ...
          undefined,
          Object.fromEntries(
            Array.from(searchParams.entries()).filter(([key]) => key !== 'redirect_url'),
          ),
        )}
